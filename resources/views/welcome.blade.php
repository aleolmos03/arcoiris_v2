...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                 <img src="{{ asset('vendor/adminlte/dist/img/ArcoirisLogo_full.png') }}" style="max-width:30%;width:auto;height:auto;">
                ...
                <div class="links">
                    ...
                    <a href="https://https://www.instagram.com">Instagram</a>
                </div>
        </div>
    </body>
</html>
